    ...
    return (
        <header id='header' class="flex justify-between content-center fixed top-0 left-0 z-50 w-full p-3 text-white md:bg-zinc-800 md:p-1">
            ...
            <div class="flex flex-wrap content-center p-1 font-normal Text-base">
                ...
                <button class="mx-3 hidden sm:flex lg:hidden"><img src="src/assets/menu.svg" alt="" /></button>
            ...
            <div class="flex content-center">
                ...
                <button class="mx-4 md:my-2 md:w-[1.5rem] md:h-[1.5rem] lg:h-7 lg:w-7 lg:my-3"><img src="src/assets/search.svg" alt="ImgSearch" /></button>
